...
void app_main(void)
{
    ...
    audio_element_handle_t http_stream_reader, mp3_decoder, aac_decoder, i2s_stream_writer;
    ...
    // Set the URI for the HTTP stream
    audio_element_set_uri(http_stream_reader, "http://192.168.9.184:8001");
